...
| Format | Méthode |
| --- | --- |
| PDF | Extraction de texte native (PyMuPDF) avec détection de titres par taille de police ; OCR (Tesseract) automatique pour les pages scannées |
...
| EPUB | Parcours de tous les chapitres du spine via `ebooklib` + conversion HTML→Markdown |
| JPEG / PNG / BMP / TIFF / GIF / WEBP | OCR Tesseract (texte extrait) |
| Pages web / fichiers HTML | Extraction du contenu principal (`readability-lxml`) puis conversion en Markdown |
